...
namespace MktAcademy.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,FirstName,LastName,DateOfBirth,Email,DocumentTypeID")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,FirstName,LastName,DateOfBirth,Email,DocumentTypeID")] Employee employee)
        {
            if (ModelState.IsValid)
            {
